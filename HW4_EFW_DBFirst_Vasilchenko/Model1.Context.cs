...
namespace HW4_EFW_DBFirst_Vasilchenko
{
    ...
    public partial class CompanyDBEntities : DbContext
    {
        ...
        public virtual int stp_EmployeeDelete1(Nullable<int> employeeID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));

            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("stp_EmployeeDelete", employeeIDParameter);
        }
        ...
        public virtual ObjectResult<stp_EmployeeByID_Result> stp_EmployeeByID(Nullable<int> employeeID)
        {
            var employeeIDParameter = employeeID.HasValue ?
                new ObjectParameter("EmployeeID", employeeID) :
                new ObjectParameter("EmployeeID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<stp_EmployeeByID_Result>("stp_EmployeeByID", employeeIDParameter);
        }
    }
}
